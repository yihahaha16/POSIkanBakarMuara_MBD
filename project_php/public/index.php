...
<a href = "tambah.php">
    <button style="background-color:#f44236;border:none;border-radius:5px;padding:7px;width:80px;color:white;cursor: pointer;" type="submit"><strong>Pesan</strong></button>
</a>
</div>
 </form>
     </div>
